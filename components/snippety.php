<script type="text/x-template" id="snippety">
    <div>
...
<script>
    Vue.component('snippety', {
        ...
        methods: {
            ...
            add(){
                let self = this;
                axios.post('api/add.php',{tabela:'snippety',dane:this.editedone}).then((res)=>{self.editedone = {};self.getData()})
            },
            update() {
