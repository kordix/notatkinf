<script type="text/x-template" id="gagi">
    <div>
            ...
            <label for="">Kod</label>
            <input type="text" v-model="editedone.gag">
            <br>
...
<script>
    Vue.component('gagi', {
        ...
        methods: {
            ...
            add(){
                let self = this;
                axios.post('api/add.php',{tabela:'gagi',dane:this.editedone}).then((res)=>{self.editedone = {};self.getData()})
            },
            update() {
